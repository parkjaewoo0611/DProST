...
pip install pandas transforms3d pytz scipy scikit-image matplotlib imageio pypng plotly opencv-python Pillow transform3d tensorboardX tensorboard vispy PyOpenGL flatten-dict
cd utils
