...
pip pandas install transforms3d pytz scipy scikit-image matplotlib imageio pypng plotly opencv-python Pillow transform3d tensorboardX tensorboard
cd utils
