...
class Preprocessor():
    def __init__(self, mode):
        ...
        self.mode = mode
        if self.mode == 'train':
            self.DATA_PATH = '../Dataset/OCCLUSION/data_linemod'
        elif self.mode == 'test':
            self.DATA_PATH = '../Dataset/OCCLUSION/data'
        self.INDEX_PATH = '../Dataset/OCCLUSION/index'
        self.BBOX_PATH = '../Dataset/OCCLUSION/test_bboxes'
